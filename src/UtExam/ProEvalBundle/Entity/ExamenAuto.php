...
class ExamenAuto
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="PreguntasAuto", inversedBy="examenAuto")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="\Application\Sonata\UserBundle\Entity\User", inversedBy="examenAuto")
     * @ORM\JoinColumn(name="user_id", referencedColumnName="id", nullable=true, onDelete="SET NULL")
     */
    private $user;

    /**
     * @ORM\ManyToMany(targetEntity="Alumnos", inversedBy="examenAuto")
     * @ORM\JoinTable(name="ExamenAuto_Alumnos",
     *     joinColumns={
     *     @ORM\JoinColumn(name="examenAuto_id", referencedColumnName="id")
     *   },
     *   inverseJoinColumns={
